$(document).ready(function(){
  ...
  $('.colors-large a').click(function(){return false;});
	...
	$('.add_to_cart').click(function(){
		...
		console.log(productImage.replace("http://smoda.kr/A_team_Project","."));
		var productName = $(productCard).find('.product_name').get(0).innerHTML;
		let productPrice = 	$(productCard).find('.product_price').get(0).innerHTML;
		selectItem[num++] = [productName,productPrice,productImage.replace("http://smoda.kr/A_team_Project",".")];
