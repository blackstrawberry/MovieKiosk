...
include ('dbConnect.php');
    ...
    $quert = "select* from  $resevationInfo";

    // 예약 좌석 SESSION 에다가 저장
    $sizeofReservation = $resevationInfo[4];
    if($sizeofReservation = 1){
        $_SESSION["resevationPeople_1"] = $resevationInfo[5];
        $_SESSION["resevationSQL"]  = "INSERT INTO tiket (reservation_no, theater, price, title, seat_1) VALUES ("$_SESSION["resevationNum"]", '"+$_SESSION["resevationPlace"]+"', "6000"
                                    , '"+$_SESSION["resevationMoiveName"] +"' , '"+$_SESSION["resevationPeople_1"]+"'" + ")";
        
    }else if($sizeofReservation = 2){
        $_SESSION["resevationPeople_1"] = $resevationInfo[5]; 
        $_SESSION["resevationPeople_2"] = $resevationInfo[6];  
        $_SESSION["resevationSQL"]  = "INSERT INTO tiket (reservation_no, theater, price, title, seat_1) VALUES ('"+$_SESSION["resevationNum"]+"', '"+$_SESSION["resevationPlace"]+"', "6000"
        , '"+$_SESSION["resevationMoiveName"]+"' , '"+$_SESSION["resevationPeople_1"]+"', '"+$_SESSION["resevationPeople_2"]+"'  ;
        ...
        $_SESSION["resevationSQL"]  = "INSERT INTO tiket (reservation_no, theater, price, title, seat_1) VALUES ('"+$_SESSION["resevationNum"]+"', '"+$_SESSION["resevationPlace"]+"', "6000"
        , '"+$_SESSION["resevationMoiveName"]+"', '"+$_SESSION["resevationPeople_1"]+"' , '"+$_SESSION["resevationMoiveName"]+"' ;
