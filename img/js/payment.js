...
function changeTotal() {
  ...
  let MoviePrice = Number(localStorage.getItem("resevationPersonnel")) *9000;
  let SnackPrice = 0;
  let i=0;
  function checkerr(){
  ...
  let snack = "Snacks: "+ SnackPrice+ "원";
  let total = "Total: "+totalPrice+"원";
...
$(document).ready(function(){
  ...
  // let MoviePrice = Number(localStorage.getItem("resevationPersonnel")) *9000;
  let MoviePrice = (2*9000);
  console.log(MoviePrice+"asdfasdfsadfas");
  let SnackPrice = 0;
  ...
  let totalPrice = Number(MoviePrice) + SnackPrice;
  document.getElementById('MoviePrice').append(MoviePrice+"원");
  document.getElementById('SnackPrice').append(SnackPrice+"원");
  document.getElementById('TotalPrice').append(totalPrice+"원");
