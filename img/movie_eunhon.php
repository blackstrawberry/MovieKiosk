      ...
      <a onclick="close_snack();"></a> 
       ...
       <div class="card">
             ...
             <div class="buttons">
               ...
               <div id="sk" class="button" onclick="snak_page();">예</div>
               <div id="pm" class="button" onclick="payment_page();">아니요</div>
             </div>
        </div>
      </div>
  </div>
            ...
            <div id="CM">
				...
				<div>
					<div>
						...
						<div class="container">
							<div class="inner_container" style="margin-top: 1%;">
												<div class="select_movie">
													...
													<select class="movie_name_place" >
														...
														<select class="movie_name" >
															<!-- <option>영화제목</option> -->
															<option selected>은혼 더 파이널</option>
